...
<link href="<c:url value="/resources/css/stylesheets_groupSetting.css" />" rel="stylesheet">
<link href="<c:url value="/resources/css/button_stylesheets.css" />" rel="stylesheet">
</head>
<body>
<h1>Group Setting Page</h1>
<p id="dtl">Group Setting</p>
<div id = "divide">
...
<div id = "psb">
<div id ="zx">
<p id="dtll">You Can Choose Four Friends</p>
<table >
    <tr>
    <td>
    <div id = "upup">
