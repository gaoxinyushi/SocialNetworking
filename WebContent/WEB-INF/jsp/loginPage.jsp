...
<link href="<c:url value="/resources/css/stylesheets_loginreg.css" />" rel="stylesheet">
...
<table id="rgtr">
            ...
            <div style="color:red" id ="regerr">${errorOfregister}</div>
</form:form>
...
<table id="ffgn">
                ...
                <tr><td>Security Question: </td><td><input name="securityQ" type="textbox"></td></tr>
                <tr><td>Security Answer: </td><td><input name="securityA" type="textbox"></td></tr>
                <tr><td id="btn_fg" colspan="2" align="right"><input type="submit" value="forget password" class="container btn color-1 material-design"></td></tr>
            </table>  
            <div style="color:red" id="fperr">${errorOffinding}</div>
</form:form>
